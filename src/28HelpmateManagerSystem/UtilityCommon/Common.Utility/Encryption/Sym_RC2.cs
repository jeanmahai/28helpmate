...
namespace Common.Utility
{
    public class Sym_RC2 : ICrypto
    {
        ...
        public string Decrypt(string encryptedBase64ConnectString)
        {
            ...
            rc.KeySize = 0x40;
            CryptoStream stream2 = new CryptoStream(stream, rc.CreateDecryptor(s_DesKey, s_DesIV), CryptoStreamMode.Write);
        ...
        public string Encrypt(string plainConnectString)
        {
            ...
            RC2 rc = new RC2CryptoServiceProvider();
            CryptoStream stream2 = new CryptoStream(stream, rc.CreateEncryptor(s_DesKey, s_DesIV), CryptoStreamMode.Write);
